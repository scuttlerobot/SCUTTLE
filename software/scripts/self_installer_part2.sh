...
# Install required Packages
  ...
  python3-setuptools libfreetype6-dev build-essential python3-smbus2 python3-pyaudio libsdl-image1.2-dev libsdl-mixer1.2-dev mjpg-streamer-opencv-python
...
# Make SSH pretty
  ...
  echo "      The Maker-Friendly Open-Source Robot: https://github.com/scuttlerobot/SCUTTLE" >> /etc/banner
  echo " " >> /etc/banner
  echo -n "" > /etc/motd
